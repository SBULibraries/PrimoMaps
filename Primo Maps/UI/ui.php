<!-- PHP variables, definitions, and initializations !-->
<?php
#Bring in variables from the other documents and define them for use on the webpage.
$xp=$_GET["xp"];
$yp=$_GET["yp"];
$si=$_GET["si"];
$image=$_GET["image"];
$call_number=$_GET["call"];
$background_image_url="https://library.stonybrook.edu/ALMA/Constant/20231210/images/$image";
$icon_image_url="https://library.stonybrook.edu/ALMA/Constant/20231210/images/arrowbook.png";
$error_message = '';
$num = (int)$si;
$lrcx = substr($si, -1);

#Example Shelves
$leftshelf="<p class='exampleShelf' id='exampleShelf'><img alt='Sorry, there does not seem to be an example of this shelf.' 
                title='You will find this item towards the left side of the shelf.' style='display:inline;' 
                src='https://library.stonybrook.edu/ALMA/Constant/20231210/images/leftshelf.png' loading='lazy'></p>";
$centershelf="<p class='exampleShelf' id='exampleShelf'><img alt='Sorry, there does not seem to be an example of this shelf.' 
                title='You will find this item towards the center of the shelf.' style='display:inline;' \
                src='https://library.stonybrook.edu/ALMA/Constant/20231210/images/centershelf.png' loading='lazy'></p>";
$rightshelf="<p class='exampleShelf' id='exampleShelf'><img alt='Sorry, there does not seem to be an example of this shelf.' 
                title='You will find this item towards the right side of the shelf.' style='display:inline;' 
                src='https://library.stonybrook.edu/ALMA/Constant/20231210/images/rightshelf.png' loading='lazy'></p>";
$xshelf="<p class='exampleShelf' id='exampleShelf'><img alt='Sorry, there does not seem to be an example of this shelf.' 
                title='You will find this item somewhere on this shelf.' style='display:inline;' 
                src='https://library.stonybrook.edu/ALMA/Constant/20231210/images/xshelf.png' loading='lazy'></p>";
$locator_icon = "<img alt='Locator Icon' title='Locator Icon' style='display:inline;' src=$icon_image_url width='30' height='30'>";

#If-Then Statements
#Calls python imgbuilder, unless the background image, 
...
#Calls python coverfinder.
if (!empty($call_number)) {
    // Escape the call number to ensure it is safe to pass to the shell
...
#Allows us to print where on the shelf the item is and display the correct example shelf image in the Right Page.
if ($num == "non") {
    $position =  "<p class='p1'>This item is located on a shelf that is not a part of the rest of the stacks.<br>
                    You'll find this item where the locator icon $locator_icon is placed.<br>
                    If you need any help finding this item, please ask at the circulation desk.</p>";
    } elseif ($lrcx == "L") {
...
#If the shelf number is 0, our descriptions are different and some information is omitted
if ($num != 0) {
    $shelfnum = "<p style='font-family: 'Effra', 'Montserrat', Times, sans-serif;
        font-size: clamp(16px, 2vw, 20px);
        font-weight: bold;
        margin-top: 0;'>
        <u>Shelf Number:</u> $num</p>";
...
<!-- Google tag (gtag.js) for analytics purposes-->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-T3EQGBEC1H"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-T3EQGBEC1H');
</script>
<body>
...
<!-- This PHP will either display the map, or an error message if a map is not correctly loaded !-->
      <?php if (empty($image_url)) {
        ...
        or email <a href='mailto:circulation@stonybrook.edu'>circulation@stonybrook.edu</a> <br></br>for assistance.";
        
                // Send an email notification
        $to = 'ill@stonybrook.edu';
        ...
        $headers = 'From: uhoh@stonybrook.edu' . "\r\n" .
                'Reply-To: ill@stonybrook.edu' . "\r\n" .
                'X-Mailer: PHP/' . phpversion();
        
        mail($to, $subject, $message, $headers);
        }
        if (empty($error_message)) {
          echo '<img src="' . $image_url . '" alt="' . $call_number . '">';
        } else {
...
<!-- This is the Right Page with Call Number Information and more !-->
    ...
    <!-- Clicking on these buttons will display the pop ups for Call Number Help Guide and Directions (see separate documents) !-->
            ...
            <p class="p1">For further assistance, please contact us at 
                <b><a href="mailto:circulation@stonybrook.edu">circulation@stonybrook.edu</a></b>.</p>
        </div>
    </div>
